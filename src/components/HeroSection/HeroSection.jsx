...
export default function HeroSection() {
    return (
        <div className="w-full ">
            ...
            {/* Main Hero Banner */}
            <section className="relative bg-gradient-to-r from-purple-800 to-purple-600 text-white overflow-hidden pb-10" style={{ backgroundImage: `url(${HeroBG})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className="container mx-auto px-4 py-10 flex flex-col-reverse md:flex-row items-center justify-between">
                    ...
                    <div className="mt-8 md:mt-0 md:w-1/2">
                        ...
                        <button className="inline-flex items-center bg-black hover:bg-gray-800 px-6 py-3 rounded text-white font-medium">
                            VIEW DEMO
